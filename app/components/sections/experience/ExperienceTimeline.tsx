                ...
                >
                  {isNewYear && (
                    <div className="relative year-container">
                      <span
                        className="text-sm text-grey-6 dark:text-grey-9 leading-[1] select-none absolute top-0 -translate-y-1/2 -rotate-[.25turn] -left-[calc(100%+14px+8px)] font-visby font-extrabold">
                        {date.year()}
                      </span>
                    </div>
                  )}
        ...
        <div className="relative h-full month-timeline">
          ...
          >
            <div className="relative h-full text-[14px] text-grey-9">
              ...
              <div
                className="absolute -translate-x-1/2 top-0 -translate-y-1/2 w-[10px] h-[1px] md:h-[10px] md:rounded-[5px] ring-0 md:ring-1 ring-blue-100 dark:ring-blue-d-200 bg-blue-100 md:bg-grey-ea dark:bg-blue-d-200 md:dark:bg-grey-2" />
              <div
                className="absolute -translate-x-1/2 bottom-0 translate-y-1/2 w-[10px] h-[1px] md:h-[10px] md:rounded-[5px] ring-0 md:ring-1 ring-blue-100 dark:ring-blue-d-200 bg-blue-100 md:bg-grey-ea dark:bg-blue-d-200 md:dark:bg-grey-2" />
            </div>
          </a.div>
        </div>
      </div>
      <div
        className="fade-up absolute -left-[8px] w-[calc(100%+16px)] h-5 top-0 bg-gradient-to-b from from-white dark:from-black" />
      <div
        className="fade-down absolute -left-[8px] w-[calc(100%+16px)] h-5 bottom-0 bg-gradient-to-t from-white dark:from-black" />
    </div>
  );
}