...
export default function DesktopNavLinks({ active }: { active: number }) {
  ...
  return (
    <nav className="absolute top-9 right-9 bg-white dark:bg-grey-2 ring-1 dark:ring-0 ring-grey-ea rounded-[10px] font-visby font-medium px-6 py-[13px] gap-6 hidden md:flex items-center overflow-hidden">
